...
@Component
@Extension
public class CreateTaiNguyenHeThongHandlerAdvice implements HandlerAdvice, ExtensionPoint {

    private final HandlerAdviceKey key;
    private final DataPermissionService dataPermissionService;

    public CreateTaiNguyenHeThongHandlerAdvice(Environment env, DataPermissionService dataPermissionService) {
        this.dataPermissionService = dataPermissionService;
        String csdl = env.getProperty("app.datasource.namespace.sso", "csdl-sso");
        this.key = new HandlerAdviceKey(csdl, "T_TaiNguyenHeThong", OpenAPI.Type.CREATE);
    }
